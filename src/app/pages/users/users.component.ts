  ...
  template: `
    ...
    <app-user-card [user]="user" isEnabled="true">
      <ng-template #cardContent>
        This is the card content that should be projected into the user card component.
      </ng-template>
    </app-user-card>
  `,
  styles: `
...
export class UsersComponent implements AfterViewInit {
  ...
  ngAfterViewInit(): void {
    console.log('UserCardComponent', this.userCard);
    console.log('UserCardComponent', this.userCards  )
  }
}
